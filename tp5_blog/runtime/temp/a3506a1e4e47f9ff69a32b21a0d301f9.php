<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"E:\wamp64\www\tp5_blog\public/../application/admin\view\group\add.html";i:1515054546;s:65:"E:\wamp64\www\tp5_blog\public/../application/admin\view\base.html";i:1515507774;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="col-xs-12 col-sm-9 col-lg-10">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active"><a href="<?php echo url('add'); ?>">添加用户组</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="title" name="title"  class="form-control" placeholder="请输入用户组中文名称">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="checkbox">
                            ...
                            <label>
                                <input type="checkbox" name="rules[]" value="<?php echo $val['id']; ?>"><?php echo $val['title']; ?>
                            </label>&nbsp;&nbsp;
