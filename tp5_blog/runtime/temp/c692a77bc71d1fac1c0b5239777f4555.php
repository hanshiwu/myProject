<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\wamp64\www\tp5_blog\public/../application/admin\view\group\index.html";i:1515419552;s:65:"E:\wamp64\www\tp5_blog\public/../application/admin\view\base.html";i:1515507774;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="col-xs-12 col-sm-9 col-lg-10">
    <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
        ...
        <li class="active">
            <a href="javascript:void(0)">用户组添加</a>
        </li>
    </ol>
    <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="<?php echo url('index'); ?>">用户组列表</a></li>
        <li><a href="<?php echo url('add'); ?>">用户组添加</a></li>
    </ul>
