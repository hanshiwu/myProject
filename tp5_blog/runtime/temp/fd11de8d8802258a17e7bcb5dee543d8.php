<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\wamp64\www\tp5_blog\public/../application/admin\view\admin\index.html";i:1515507240;s:65:"E:\wamp64\www\tp5_blog\public/../application/admin\view\base.html";i:1515507774;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="col-xs-12 col-sm-9 col-lg-10">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li><a href="<?php echo url('admin/add'); ?>">用户添加</a></li>
    </ul>
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <div class="btn-group">
                                <a href="<?php echo url('admin/edit',['id'=>$vo['id']]); ?>">编辑</a>&nbsp;|
                                <a href="<?php echo url('admin/setAuth',['id'=>$vo['id']]); ?>">分配权限</a>&nbsp;|
