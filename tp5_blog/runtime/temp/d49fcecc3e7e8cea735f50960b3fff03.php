<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"E:\wamp64\www\tp5_blog\thinkphp\tpl\dispatch_jump.tpl";i:1515418720;}*/ ?>
...
<input type="hidden" name="info" value="<?php switch ($code) { case 1:?>
    <?php echo('success');break;case 0:?>
    <?php echo('error');break;} ?>
"/>
<script>
